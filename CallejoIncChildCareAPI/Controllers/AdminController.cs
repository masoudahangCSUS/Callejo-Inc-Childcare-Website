...
namespace CallejoIncChildcareAPI.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        // GET: api/admin/get-all-photos
        [HttpGet("get-all-photos")]
        public async Task<ActionResult<APIResponse>> GetImages()
        {
            try
            {
                ...
                Console.WriteLine("DEBUG: No images found despite API returning results.");
                return NotFound(new APIResponse
                {
                    Success = false,
                    Message = "No images found in Google Drive."
                });
            }
            catch (Exception ex)
            {
